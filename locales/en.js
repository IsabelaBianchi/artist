export default {
    ...
    about: 'Augusto Baschera is a guitarist and composer born in southern Brazil, where his musical journey began at a very early age within a family deeply connected to music. From the age of four, music became both language and discipline, shaping an artistic path guided by dedication, expressive depth, and a strong sense of commitment. Early exposure to the stage through Latin American festivals broadened his artistic vision, allowing his identity to evolve beyond borders while remaining firmly rooted in his cultural origins. Augusto holds a Master’s degree in Performance (Guitar) from the Escola Superior de Música de Lisboa. His work as a composer and instrumentalist has materialized in four albums released under his own name, widely recognized by the international contemporary and improvised music press. His artistic output establishes a continuous dialogue between tradition and modernity',
    about_biografy_1: "Augusto's journey is an intense path of dedication, practice, passion, and commitment to music. He is a musician who knows the European tradition of classical music and the roots of popular and improvised music.",
    about_biografy_2: "Still very young, he internationalized his music across South America, traveling to countries such as Argentina, Uruguay, Paraguay, and Mexico.",
    about_biografy_3: "He was awarded in competitions and festivals as an instrumentalist, composer, and arranger.",
    about_biografy_4: "Augusto Baschera holds a Master's degree in Performance from the Escola Superior de Música de Lisboa – Portugal. As an educator, he has taught classes and workshops at educational institutions across South America and Europe.",
    about_biografy_5: 'He has a discography of 4 albums: the first, "Palavra de Fantoche" (2019), the second, "Grey City" (2020), resulting from a duo with pianist João Bernardo, the third album "Tempos e Lugares" (2023) recorded live at Teatro Micaelense – Azores, Portugal, and the most recent, "APÓCRIFO" (2025), an album recorded in Lisbon with his Quartet.',
    about_biografy_6: 'Augusto has been mentioned by the international Jazz and contemporary improvised music press, receiving recognition from the magazines "Simply Jazz Talk", "Jazziz", "All About Jazz", "Jazz pt", "Caravan", "Latin Jazz", "Fifteen Questions - Directions in Jazz", and "JazzOrg".',
    about_biografy_7: "He currently dedicates his life to composition and improvised music.",
    ...
    quarteto_desc: 'Formed by guitar, piano, bass, and drums, the Augusto Baschera Quartet is a jazz project that stands out for its innovative language and the strong personality of its members. The quartet features Augusto Baschera on guitar, João Bernardo on piano, Kim Baiunco on bass, and Vini Baschera on drums.',
    coquillage_tl_tittle: 'Le Coquillage d’Or des Mers',
    coquillage_tl_description: '"Musical theatre based on a Portuguese tale, presented in October 2025 at the Philharmonie Luxembourg, as part of the Atlantic Festival.',
    project_apocrifo_title: 'APÓCRIFO',
    project_folclore_title: 'MasterClass - Folkloric Traditions as a Tool for the Development and Creation of Contemporary Music',
    project_folclore_description:'A creative dive into folkloric traditions, exploring melodic, harmonic, and rhythmic elements, transforming them into new expressions of contemporary music through composition and improvisation.',
    ...
    project_tl_tittle: 'Tempos e Lugares - Live at Teatro Micaelense',
